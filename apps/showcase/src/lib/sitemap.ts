...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Foundry", href: "/variants/foundry" },
      { label: "Vellum", href: "/variants/vellum" },
      { label: "Beacon", href: "/variants/beacon" },
      { label: "Marginalia", href: "/variants/marginalia" },
      { label: "Proscenium", href: "/variants/proscenium" },
      { label: "Caesura", href: "/variants/caesura" },
      { label: "Cipher", href: "/variants/cipher" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Marketing", href: "/variants/foundry/templates/marketing-landing" },
